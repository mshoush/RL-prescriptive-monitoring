...
logs_dir = "/home/centos/phd/3rdyear/2nd/myCode/prepared_data/"
...
bpic2017_dict = {"bpic2017": "bpic2017/prepared_treatment_outcome_time_to_event_bpic2017.csv"}
...
for dataset, fname in bpic2017_dict.items():
    ...
    dynamic_cat_cols[dataset] = ["Activity", 'org:resource', 'Action', 'EventOrigin', 'lifecycle:transition', "Accepted", "Selected", 'time_to_event_m']
...
for dataset, fname in bpic2012_dict.items():
    ...
    # features for classifier
    dynamic_cat_cols[dataset] = ["Activity", 'Resource', 'time_to_event_m'] #'Action', 'EventOrigin', 'lifecycle:transition', "Accepted", "Selected"]
